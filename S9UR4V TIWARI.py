...
\033[1;33m╚══════╝ ╚═════╝  ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝  ╚═══╝  
	...
	\033[1;37;1m  Author   : S9UR4V TIWARI 
\033[1;37;1m  Facebook : https://www.facebook.com/Sourav008
\033[1;37;1m  Whatsapp : +91 9106391471
    ...
    for line in lines:
        if len(line) > 3:
            ...
            if count % 10 == 0:
                ...
                clear()
                print("\033[0;37;41m\n")
r1=requests.get("https:https://github.com/Sourav9106/Sourav/blob/main/Tiwari.txt").text
